...
For the deeper CuTe machinery (layouts, tensors, partitioning, MMA atoms), refer to the [CuTe DSL fundamentals notes](#). For the next kernel in the worklog, see [K2: Tiled online softmax](/blog/2026/fa3-k2/).