Say, what is this about + Add for personal notes and references later comment

Few things before
- Claude generated
- Please let me know if some reasoning is wrong
- References - quantization blog
- Link to PR and this complete code file
- Thought: in prod inference, kernel is 50%, and the other 50% is making the kernel faster from outside.
- Added extra info as notes block
