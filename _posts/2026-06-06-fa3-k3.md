...
This is the in-depth companion to the [K3 section of the FA3 worklog](/blog/2026/fa3-worklog/). Refer back there for the high-level idea — TMA replaces K2's strided loads, the producer/consumer pipeline sets up overlap K4 will lean on, and the substages 1 → 2 → 5 are structural preparation for K4. This post covers the mechanics: what TMA actually is, how the pipeline protocol works, what mbarriers do, and the CuTe API for putting it all together.
...
For the next kernel in the worklog, see [K4: WGMMA](/blog/2026/fa3-k4/).